...
<section class="announcments bg-secondary">
    <div class="announcments-container">
        <div class="grid">
            ...
            <div class="grid gap-xl@md padding-top-lg">
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/light.png"></span>
                             <h3>Jasne zasady</h3>
                        </div>
                        <div>
                            <p>Dzięki dokładnie sprecyzowanym i całkowicie transparentnym ofertom, dokładnie wiesz na czym polega praca.</p>
                        </div>
                    </div>
                    <div></div>
                </div>
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/money.png"></span>
            ...
            <div class="grid gap-xl@md">
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/award.png"></span>
                             <h3>Inwestycja w przyszłość</h3>
                        </div>
                        <div>
                          <p>Tworząc profil na Jobsy i zbierając opinie, budujesz swoją wiarygodność i zwiększasz szanse na lepsze zarobki.</p>
                        </div>
                    </div>
                    <div></div>
                </div>
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-clock.png"></span>
            ...
            <div class="grid gap-xl@md">
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/hand.png"></span>
                             <h3>Minimum formalności</h3>
                        </div>
                        <div>
                            <p>Umowy podpisywane są elektronicznie, a rozliczeniami zajmujemy się my. Ty możesz skupić się wyłącznie na pracy.</p>
                        </div>
                    </div>
                    <div></div>
                </div>
                ...
                <div class="padding-bottom-lg">
                        <div class="flex items-center padding-bottom-xs flex-column flex-row@md">
                            <span class="ann-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/triangles.png"></span>
                             <h3>Oszczędność czasu</h3>
                        </div>
                        <div>
                            <p>Dbamy o to, aby Twoje zatrudnienie przebiegło szybko i sprawnie, a obie strony były zadowolone ze współpracy.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <img class="photo-announcment" src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl-red.png" alt="kobieta dziewczyna uśmiech praca">
</section>
...
<img class="mobile-coffe " src="<?php echo get_stylesheet_directory_uri(); ?>/images/mobile-coffe.png" alt="iphone telefon kawa promocja aplikacja jobsy">
    <div class="container max-width-lg">
        <div class="grid">
            <div class="col-4@lg margin-top-lg@md">
                <h2 class="padding-bottom-xs">Jak proste jest <br>korzystanie z Jobsy</h2>
                <p>Opracowaliśmy naszą aplikację w taki sposób, aby korzystanie z niej było maksymalnie intuicyjne. Rekrutacja i poszukiwanie pracy jeszcze nigdy nie były tak proste!</p>
                <a href="" class="btn btn--green margin-bottom-sm margin-right-xxl@lg"><span>Szukasz pracy, pobierz aplikację</span></a>
                <a href="" class="btn btn--white"><span>Zacznij zatrudniać, zarejestruj się</span></a>
            </div>
            <div class="col@md">
                <div class="mac-hp">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/hp-macbook.png" alt="macbook komputer jobsy">
                </div>
            </div>
        </div>
    </div>
