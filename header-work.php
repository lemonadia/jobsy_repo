...
<body <?php body_class( '' ); ?>>
    <header class="header-v3 bg-work position-relative js-header-v3 padding-top-lg padding-top-xl@md">
        <div class="header-v3__container bg-work container max-width-lg">
            <div class="header-v3__logo">
                <a href="/">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logowhite.png"
                        alt="jobsy agencja pracy praca tymczasowa">
                </a>
            </div>
                ...
                <ul class="header-v3__nav-list">
                    ...
                    <div class="flex">
                        <div class="navigation-items">
                            <li class="header-v3__nav-item"><a href="#0" class="header-v3__nav-link">Dla Pracownika</a>
                            </li>
